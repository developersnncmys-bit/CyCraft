'use client';
/* Courses Hero — autoplay reveal on load (NOT pinned)
 *
 * Same architecture as AboutHero: waits for the preloader to finish, then
 * runs a word-by-word reveal. The accent line uses red-team instead of
 * cyan-beam to match the catalogue's offensive-security framing in the
 * client mockups.
 */
...
import { coursesHeroContent } from '@/content/courses/hero';
...
export default function CoursesHero() {
  ...
  useGSAP(
    () => {
      ...
      const revealTargets = [
        '.courses-hero-badge',
        '.courses-hero-line-1 [data-word]',
        '.courses-hero-line-2 [data-word]',
        '.courses-hero-divider',
        '.courses-hero-tagline [data-word]',
        '.courses-hero-pill',
        '.courses-hero-terminal-line',
      ];
      ...
      gsap.set(['.courses-hero-badge', '.courses-hero-terminal-line'], { opacity: 0, y: 18 });
      gsap.set('.courses-hero-line-1 [data-word], .courses-hero-line-2 [data-word]', {
        opacity: 0,
        yPercent: 60,
        filter: 'blur(10px)',
      });
      gsap.set('.courses-hero-divider', { scaleX: 0, transformOrigin: 'left center' });
      gsap.set('.courses-hero-tagline [data-word]', { opacity: 0, y: 8, filter: 'blur(4px)' });
      gsap.set('.courses-hero-pill', { opacity: 0, y: 10 });

      const playEntry = () => {
        const tl = gsap.timeline({ defaults: { ease: 'power3.out' } });
        tl.to('.courses-hero-badge', { opacity: 1, y: 0, duration: 0.6 })
          .to(
            '.courses-hero-line-1 [data-word]',
          ...
          .to('.courses-hero-divider', { scaleX: 1, duration: 0.5 }, '-=0.25')
          .to(
            '.courses-hero-tagline [data-word]',
      ...
      gsap.to('.courses-hero-bg-layer', { yPercent: 12, ease: 'none', scrollTrigger: parallax });
      gsap.to('.courses-hero-mid-near', {
        yPercent: 25,
        scale: 1.15,
        opacity: 0.45,
        ease: 'none',
  ...
  return (
    ...
    >
      ...
      <div
        aria-hidden="true"
        className="courses-hero-mid-far"
        style={{
          position: 'absolute',
          inset: 0,
          zIndex: 2,
      ...
      <div
        aria-hidden="true"
        className="courses-hero-mid-near"
        style={{
          position: 'absolute',
          top: '50%',
          left: '50%',
      ...
      <div
        className="courses-hero-fg section-container"
        style={{
          position: 'relative',
          zIndex: 6,
          width: '100%',
      ...
      >
        <div style={{ maxWidth: '1100px', marginInline: 'auto' }}>
          ...
          >
            ...
            <Badge label={coursesHeroContent.badge} />
          </div>

          <h1
            className="courses-hero-headline"
            style={{
              width: '100%',
          ...
          >
            <WordSplit
              className="courses-hero-line-1"
              text={coursesHeroContent.headlinePrefix}
              style={{
                display: 'inline',
            ...
            />{' '}
            <WordSplit
              className="courses-hero-line-2"
              text={coursesHeroContent.headlineAccent}
              style={{
                display: 'inline',
          ...
          <div
            className="courses-hero-divider"
            aria-hidden="true"
            style={{
              width: '80px',
              height: '2px',
          ...
          <p
            className="courses-hero-tagline"
            style={{
          ...
          >
            <WordSplit text={coursesHeroContent.tagline} />
          </p>
          ...
          >
            {coursesHeroContent.pills.map((pill) => (
              <span
                key={pill.label}
                className="courses-hero-pill"
                style={{
                  display: 'inline-flex',
                  alignItems: 'center',
                  gap: '0.5rem',
          ...
          >
            {coursesHeroContent.terminalLines.map((line) => (
              <span key={line} className="courses-hero-terminal-line">
                {line}
              </span>
            ))}
          </div>
